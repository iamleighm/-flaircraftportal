  ...
  \***********************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* WEBPACK VAR INJECTION */ (function ($) {
                    ...
                    /* harmony import */ var _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_0__ =
                        __webpack_require__(
                            /*! @bigcommerce/stencil-utils */ './node_modules/@bigcommerce/stencil-utils/src/main.js',
                        );
                    /* harmony import */ var _catalog__WEBPACK_IMPORTED_MODULE_1__ =
                        __webpack_require__(
                            /*! ./catalog */ './assets/js/theme/catalog.js',
                        );
                    /* harmony import */ var _common_faceted_search__WEBPACK_IMPORTED_MODULE_2__ =
                        __webpack_require__(
                            /*! ./common/faceted-search */ './assets/js/theme/common/faceted-search.js',
                        );
                    ...
                    /* harmony import */ var _global_compare_products__WEBPACK_IMPORTED_MODULE_4__ =
                        __webpack_require__(
                            /*! ./global/compare-products */ './assets/js/theme/global/compare-products.js',
                        );
                    /* harmony import */ var _common_utils_url_utils__WEBPACK_IMPORTED_MODULE_5__ =
                        __webpack_require__(
                            /*! ./common/utils/url-utils */ './assets/js/theme/common/utils/url-utils.js',
                        );
                    /* harmony import */ var url__WEBPACK_IMPORTED_MODULE_6__ =
                        __webpack_require__(
                            /*! url */ './node_modules/url/url.js',
                        );
                    /* harmony import */ var url__WEBPACK_IMPORTED_MODULE_6___default =
                        /*#__PURE__*/ __webpack_require__.n(
                            url__WEBPACK_IMPORTED_MODULE_6__,
                        );
                    /* harmony import */ var _common_collapsible__WEBPACK_IMPORTED_MODULE_7__ =
                        __webpack_require__(
                            /*! ./common/collapsible */ './assets/js/theme/common/collapsible.js',
                        );
                    /* harmony import */ var jstree__WEBPACK_IMPORTED_MODULE_8__ =
                        __webpack_require__(
                            /*! jstree */ './node_modules/jstree/dist/jstree.min.js',
                        );
                    /* harmony import */ var jstree__WEBPACK_IMPORTED_MODULE_8___default =
                        /*#__PURE__*/ __webpack_require__.n(
                            jstree__WEBPACK_IMPORTED_MODULE_8__,
                        );
                    /* harmony import */ var _common_nod__WEBPACK_IMPORTED_MODULE_9__ =
                        __webpack_require__(
                    ...
                    var Search = /*#__PURE__*/ (function (_CatalogPage) {
                        ...
                        _proto.formatCategoryTreeForJSTree =
                            function formatCategoryTreeForJSTree(node) {
                                var _this = this;
                                ...
                                if (node.children) {
                                    ...
                                    node.children.forEach(function (childNode) {
                                        nodeData.children.push(
                                            _this.formatCategoryTreeForJSTree(
                                                childNode,
                                            ),
                                        );
                                    });
                        ...
                        _proto.showProducts = function showProducts(navigate) {
                            ...
                            $('[data-content-results-toggle]').addClass(
                                'navBar-action',
                            );
                            $('[data-product-results-toggle]').removeClass(
                                'navBar-action',
                            );
                            $('[data-product-results-toggle]').addClass(
                                'navBar-action-color--active',
                            );
                            this.activateTab(
                                $('[data-product-results-toggle]'),
                            );
                            ...
                            var url =
                                searchData.count > 0
                                    ? searchData.url
                                    : _common_utils_url_utils__WEBPACK_IMPORTED_MODULE_5__[
                                          'default'
                                      ].replaceParams(searchData.url, {
                                          page: 1,
                                      });
                            _common_utils_url_utils__WEBPACK_IMPORTED_MODULE_5__[
                                'default'
                        ...
                        _proto.activateTab = function activateTab(
                            $tabToActivate,
                        ) {
                            var $tabsCollection = $(
                        ...
                        _proto.onTabChangeWithArrows =
                            function onTabChangeWithArrows(event) {
                                var eventKey = event.which;
                                var isLeftOrRightArrowKeydown =
                                    eventKey === leftArrowKey ||
                                    eventKey === rightArrowKey;
                                if (!isLeftOrRightArrowKeydown) return;
                                var $tabsCollection = $(
                                    '[data-search-page-tabs]',
                                ).find('[role="tab"]');
                                var isActiveElementNotTab =
                                    $tabsCollection.index(
                                ...
                                var activeTabIdx =
                                    $tabsCollection.index($activeTab);
                        ...
                        _proto.onReady = function onReady() {
                            ...
                            Object(
                                _global_compare_products__WEBPACK_IMPORTED_MODULE_4__[
                                    'default'
                                ],
                            )(this.context);
                            this.arrangeFocusOnSortBy();
                            var $searchForm = $('[data-advanced-search-form]');
                            var $categoryTreeContainer = $searchForm.find(
                                '[data-search-category-tree]',
                            );
                            var url =
                                url__WEBPACK_IMPORTED_MODULE_6___default.a.parse(
                                    window.location.href,
                                    true,
                                );
                            var treeData = [];
                            this.$productListingContainer = $(
                                '#product-listing-container',
                            );
                            this.$facetedSearchContainer = $(
                                '#faceted-search-container',
                            );
                            this.$contentResultsContainer = $(
                            ...
                            if ($('#facetedSearch').length > 0) {
                                ...
                                _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_0__[
                                    'hooks'
                                ].on('sortBy-submitted', this.onSortBySubmit);
                            } // Init collapsibles

                            Object(
                                _common_collapsible__WEBPACK_IMPORTED_MODULE_7__[
                                    'default'
                                ],
                            )();
                            $('[data-product-results-toggle]').on(
                                'click',
                                function (event) {
                            ...
                            $('[data-content-results-toggle]').on(
                                'click',
                                function (event) {
                                    event.preventDefault();
                            ...
                            var validator = this.initValidation(
                                $searchForm,
                            ).bindValidation(
                            ...
                            this.context.categoryTree.forEach(function (node) {
                                treeData.push(
                                    _this2.formatCategoryTreeForJSTree(node),
                                );
                            });
                            this.categoryTreeData = treeData;
                            this.createCategoryTree($categoryTreeContainer);
                            $searchForm.on('submit', function (event) {
                                var selectedCategoryIds = $categoryTreeContainer
                                    .jstree()
                                    .get_selected();
                        ...
                        _proto.loadTreeNodes = function loadTreeNodes(
                            node,
                            cb,
                        ) {
                            var _this3 = this;
                            ...
                            $.ajax({
                                ...
                                data.forEach(function (dataNode) {
                                    formattedResults.push(
                                        _this3.formatCategoryTreeForJSTree(
                                            dataNode,
                                        ),
                                    );
                                });
                        ...
                        _proto.createCategoryTree = function createCategoryTree(
                            $container,
                        ) {
                            var _this4 = this;
                        ...
                        _proto.initFacetedSearch =
                            function initFacetedSearch() {
                                ...
                                var _this$context = this.context,
                                    onMinPriceError =
                                        _this$context.onMinPriceError,
                                    onMaxPriceError =
                                        _this$context.onMaxPriceError,
                                    minPriceNotEntered =
                                        _this$context.minPriceNotEntered,
                                    maxPriceNotEntered =
                                        _this$context.maxPriceNotEntered,
                                    onInvalidPrice =
                                        _this$context.onInvalidPrice;
                                var $productListingContainer = $(
                                    '#product-listing-container',
                                );
                                var $contentListingContainer = $(
                                    '#search-results-content',
                                );
                                ...
                                var productsPerPage =
                                    this.context.searchProductsPerPage;
                                var requestOptions = {
                                    template: {
                                        productListing:
                                ...
                                this.facetedSearch =
                                    new _common_faceted_search__WEBPACK_IMPORTED_MODULE_2__[
                                        'default'
                                    ](
                                        requestOptions,
                                        function (content) {
                                            ...
                                            if (
                                                ...
                                                $productListingContainer.html(
                                                    content.productListing,
                                                );
                                                $facetedSearchContainer.html(
                                                    content.sidebar,
                                                );
                                                $searchCount.html(
                        ...
                        _proto.initValidation = function initValidation($form) {
                            ...
                            this.validator = Object(
                                _common_nod__WEBPACK_IMPORTED_MODULE_9__[
                                    'default'
                                ],
                            )({
                                submit: $form,
