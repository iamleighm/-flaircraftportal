  ...
  \************************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* WEBPACK VAR INJECTION */ (function ($) {
                    ...
                    /* harmony import */ var _product_reviews__WEBPACK_IMPORTED_MODULE_1__ =
                        __webpack_require__(
                            /*! ./product/reviews */ './assets/js/theme/product/reviews.js',
                        );
                    /* harmony import */ var _common_collapsible__WEBPACK_IMPORTED_MODULE_2__ =
                        __webpack_require__(
                            /*! ./common/collapsible */ './assets/js/theme/common/collapsible.js',
                        );
                    /* harmony import */ var _common_product_details__WEBPACK_IMPORTED_MODULE_3__ =
                        __webpack_require__(
                            /*! ./common/product-details */ './assets/js/theme/common/product-details.js',
                        );
                    /* harmony import */ var _product_video_gallery__WEBPACK_IMPORTED_MODULE_4__ =
                        __webpack_require__(
                            /*! ./product/video-gallery */ './assets/js/theme/product/video-gallery.js',
                        );
 ...
 */
                    ...
                    var Product = /*#__PURE__*/ (function (_PageManager) {
                        ...
                        function Product(context) {
                            ...
                            _this.$bulkPricingLink = $(
                                '[data-reveal-id="modal-bulk-pricing"]',
                            );
                            _this.reviewModal = Object(
                        ...
                        _proto.onReady = function onReady() {
                            ...
                            $(document).on('close.fndtn.reveal', function () {
                                if (
                                    _this2.url.indexOf('#write_review') !==
                                        -1 &&
                            ...
                            Object(
                                _common_collapsible__WEBPACK_IMPORTED_MODULE_2__[
                                    'default'
                                ],
                            )();
                            this.productDetails =
                                new _common_product_details__WEBPACK_IMPORTED_MODULE_3__[
                                    'default'
                                ](
                                    $('.productView'),
                                    this.context,
                            ...
                            Object(
                                _product_video_gallery__WEBPACK_IMPORTED_MODULE_4__[
                                    'default'
                                ],
                            )();
                            this.bulkPricingHandler();
                            var $reviewForm = Object(
                            ...
                            var review =
                                new _product_reviews__WEBPACK_IMPORTED_MODULE_1__[
                                    'default'
                                ]({
                            ...
                            $('body').on(
                                ...
                                function () {
                                    ...
                                    _this2.ariaDescribeReviewInputs(
                                        $reviewForm,
                                    );
                                },
                            );
                        ...
                        _proto.ariaDescribeReviewInputs =
                            function ariaDescribeReviewInputs($form) {
                                $form
                                    .find('[data-input]')
                        ...
                        _proto.productReviewHandler =
                            function productReviewHandler() {
                                if (this.url.indexOf('#write_review') !== -1) {
                                    this.$reviewLink.trigger('click');
                                }
                            };

                        _proto.bulkPricingHandler =
                            function bulkPricingHandler() {
                ...
                /* WEBPACK VAR INJECTION */ (function ($) {
                    ...
                    var VideoGallery = /*#__PURE__*/ (function () {
                        ...
                        _proto.setActiveThumb = function setActiveThumb() {
                            ...
                            this.currentVideo.$selectedThumb.addClass(
                                'is-active',
                            );
                        };
                    ...
                    function videoGallery() {
                        ...
                        $videoGallery.each(function (index, element) {
                            var $el = $(element);
                            var isInitialized =
                                $el.data(pluginKey) instanceof VideoGallery;
