  ...
  \*********************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* WEBPACK VAR INJECTION */ (function ($) {
                    ...
                    /* harmony import */ var lodash_bind__WEBPACK_IMPORTED_MODULE_1__ =
                        __webpack_require__(
                            /*! lodash/bind */ './node_modules/lodash/bind.js',
                        );
                    /* harmony import */ var lodash_bind__WEBPACK_IMPORTED_MODULE_1___default =
                        /*#__PURE__*/ __webpack_require__.n(
                            lodash_bind__WEBPACK_IMPORTED_MODULE_1__,
                        );
                    /* harmony import */ var _page_manager__WEBPACK_IMPORTED_MODULE_2__ =
                        __webpack_require__(
                            /*! ./page-manager */ './assets/js/theme/page-manager.js',
                        );
                    /* harmony import */ var _common_gift_certificate_validator__WEBPACK_IMPORTED_MODULE_3__ =
                        __webpack_require__(
                            /*! ./common/gift-certificate-validator */ './assets/js/theme/common/gift-certificate-validator.js',
                        );
                    /* harmony import */ var _common_utils_translations_utils__WEBPACK_IMPORTED_MODULE_4__ =
                        __webpack_require__(
                            /*! ./common/utils/translations-utils */ './assets/js/theme/common/utils/translations-utils.js',
                        );
                    /* harmony import */ var _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_5__ =
                        __webpack_require__(
                            /*! @bigcommerce/stencil-utils */ './node_modules/@bigcommerce/stencil-utils/src/main.js',
                        );
                    /* harmony import */ var _cart_shipping_estimator__WEBPACK_IMPORTED_MODULE_6__ =
                        __webpack_require__(
                            /*! ./cart/shipping-estimator */ './assets/js/theme/cart/shipping-estimator.js',
                        );
                    /* harmony import */ var _global_modal__WEBPACK_IMPORTED_MODULE_7__ =
                        __webpack_require__(
                            /*! ./global/modal */ './assets/js/theme/global/modal.js',
                        );
                    /* harmony import */ var _common_cart_item_details__WEBPACK_IMPORTED_MODULE_8__ =
                        __webpack_require__(
                            /*! ./common/cart-item-details */ './assets/js/theme/common/cart-item-details.js',
                        );
                    ...
                    var Cart = /*#__PURE__*/ (function (_PageManager) {
                        ...
                        _proto.setApplePaySupport =
                            function setApplePaySupport() {
                                if (window.ApplePaySession) {
                                    this.$cartPageContent.addClass(
                                        'apple-pay-supported',
                                    );
                                }
                            };
                        ...
                        _proto.cartUpdate = function cartUpdate($target) {
                            ...
                            var newQty =
                                $target.data('action') === 'inc'
                                    ? oldQty + 1
                                    : oldQty - 1; // Does not quality for min/max quantity

                            if (newQty < minQty) {
                                return Object(
                                    _global_modal__WEBPACK_IMPORTED_MODULE_7__[
                                        'showAlertModal'
                                    ],
                                )(minError);
                        ...
                        _proto.cartUpdateQtyTextChange =
                        ...
                        _proto.cartRemoveItem = function cartRemoveItem(
                            itemId,
                        ) {
                            var _this3 = this;
                        ...
                        _proto.cartEditOptions = function cartEditOptions(
                            itemId,
                            productId,
                        ) {
                            var _this4 = this;
                                ...
                                function (err, response) {
                                    ...
                                    var optionChangeHandler =
                                        function optionChangeHandler() {
                                            var $productOptionsContainer = $(
                                                '[data-product-attributes-wrapper]',
                                                _this4.$modal,
                                            );
                                            var modalBodyReservedHeight =
                                    ...
                                    _this4.productDetails =
                                        new _common_cart_item_details__WEBPACK_IMPORTED_MODULE_8__[
                                            'default'
                                        ](_this4.$modal, context);
                        ...
                        _proto.refreshContent = function refreshContent(
                            ...
                            _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_5__[
                                ...
                                function (err, response) {
                                    ...
                                    _this5.$cartMessages.html(
                                        response.statusMessages,
                                    );

                                    _this5.$cartAdditionalCheckoutBtns.html(
                                        response.additionalCheckoutButtons,
                                    );

                                    $cartPageTitle.replaceWith(
                                        response.pageTitle,
                                    );
                                    ...
                                    $(
                                        "[data-cart-itemid='" +
                                            _this5.$activeCartItemId +
                                            "']",
                                        _this5.$cartContent,
                                    )
                                        .filter(
                                            "[data-action='" +
                                                _this5.$activeCartItemBtnAction +
                                                "']",
                                        )
                                        .trigger('focus');
                                },
                        ...
                        _proto.bindCartEvents = function bindCartEvents() {
                            ...
                            var cartUpdate =
                                lodash_bind__WEBPACK_IMPORTED_MODULE_1___default()(
                            ...
                            var cartUpdateQtyTextChange =
                                lodash_bind__WEBPACK_IMPORTED_MODULE_1___default()(
                                    lodash_debounce__WEBPACK_IMPORTED_MODULE_0___default()(
                                        this.cartUpdateQtyTextChange,
                                        debounceTimeout,
                                    ),
                                    this,
                                );
                            ...
                            $('[data-cart-update]', this.$cartContent).on(
                                'click',
                                function (event) {
                            ...
                            $('.cart-remove', this.$cartContent).on(
                                'click',
                                function (event) {
                                    var itemId = $(event.currentTarget).data(
                                        'cartItemid',
                                    );
                                    var string = $(event.currentTarget).data(
                                        'confirmDelete',
                                    );
                                    Object(
                                        _global_modal__WEBPACK_IMPORTED_MODULE_7__[
                            ...
                            $('[data-item-edit]', this.$cartContent).on(
                                'click',
                                function (event) {
                                    var itemId = $(event.currentTarget).data(
                                        'itemEdit',
                                    );
                                    var productId = $(event.currentTarget).data(
                                        'productId',
                                    );
                        ...
                        _proto.bindGiftCertificateEvents =
                            function bindGiftCertificateEvents() {
                                ...
                                $certForm.on('submit', function (event) {
                                    ...
                                    if (
                                        !Object(
                                            _common_gift_certificate_validator__WEBPACK_IMPORTED_MODULE_3__[
                                                'default'
                                            ],
                                        )(code)
                                    ) {
                                        var validationDictionary = Object(
                                            _common_utils_translations_utils__WEBPACK_IMPORTED_MODULE_4__[
                            ...
                            function bindGiftWrappingEvents() {
                                ...
                                $('[data-item-giftwrap]').on(
                                    ...
                                    function (event) {
                                        ...
                                        var options = {
                                            template:
                                                'cart/modals/gift-wrapping-form',
                                        };
                                        event.preventDefault();
                                        modal.open();
                                        _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_5__[
                        ...
                        _proto.bindGiftWrappingForm =
                            function bindGiftWrappingForm() {
                                $('.giftWrapping-select').on(
                                    'change',
                                    function (event) {
                                        ...
                                        var allowMessage = $select
                                            .find('option[value=' + id + ']')
                                            .data('allowMessage');
                                        $(
                                            '.giftWrapping-image-' + index,
                                        ).hide();
                                        $(
                                            '#giftWrapping-image-' +
                                                index +
                        ...
                        _proto.bindEvents = function bindEvents() {
                            ...
                            var shippingErrorMessages = {
                                country:
                                    this.context.shippingCountryErrorMessage,
                                province:
                                    this.context.shippingProvinceErrorMessage,
                            };
                            this.shippingEstimator =
                                new _cart_shipping_estimator__WEBPACK_IMPORTED_MODULE_6__[
                                    'default'
                                ](
  ...
  \****************************************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* WEBPACK VAR INJECTION */ (function ($) {
                    ...
                    /* harmony import */ var _common_state_country__WEBPACK_IMPORTED_MODULE_0__ =
                        __webpack_require__(
                            /*! ../common/state-country */ './assets/js/theme/common/state-country.js',
                        );
                    /* harmony import */ var _common_nod__WEBPACK_IMPORTED_MODULE_1__ =
                        __webpack_require__(
                            /*! ../common/nod */ './assets/js/theme/common/nod.js',
                        );
                    /* harmony import */ var _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_2__ =
                        __webpack_require__(
                            /*! @bigcommerce/stencil-utils */ './node_modules/@bigcommerce/stencil-utils/src/main.js',
                        );
                    /* harmony import */ var _common_utils_form_utils__WEBPACK_IMPORTED_MODULE_3__ =
                        __webpack_require__(
                            /*! ../common/utils/form-utils */ './assets/js/theme/common/utils/form-utils.js',
                        );
                    /* harmony import */ var _common_collapsible__WEBPACK_IMPORTED_MODULE_4__ =
                        __webpack_require__(
                            /*! ../common/collapsible */ './assets/js/theme/common/collapsible.js',
                        );
                    /* harmony import */ var _global_modal__WEBPACK_IMPORTED_MODULE_5__ =
                        __webpack_require__(
                            /*! ../global/modal */ './assets/js/theme/global/modal.js',
                        );
                    ...
                    var ShippingEstimator = /*#__PURE__*/ (function () {
                        ...
                        _proto.initFormValidation =
                            function initFormValidation() {
                                var _this = this;

                                var shippingEstimatorAlert =
                                    $('.shipping-quotes');
                                this.shippingEstimator =
                                    'form[data-shipping-estimator]';
                                this.shippingValidator = Object(
                                    _common_nod__WEBPACK_IMPORTED_MODULE_1__[
                                        'default'
                                    ],
                                )({
                                    submit:
                                    ...
                                    tap: _common_utils_form_utils__WEBPACK_IMPORTED_MODULE_3__[
                                ...
                                $(
                                    ...
                                    if (shippingEstimatorAlert.attr('role')) {
                                        shippingEstimatorAlert.removeAttr(
                                            'role',
                                        );
                                    }

                                    shippingEstimatorAlert.attr(
                                        'role',
                                        'alert',
                                    ...
                                    if (
                                        _this.shippingValidator.areAll('valid')
                                    ) {
                                        return;
                                    }
                            ...
                            this.shippingValidator.add([
                                {
                                    ...
                                    errorMessage:
                                        this.shippingErrorMessages.country,
                                },
                            ]);
                        };

                        _proto.bindStateValidation =
                            function bindStateValidation() {
                                var _this2 = this;
                                        ...
                                        validate: function validate(cb) {
                                            ...
                                            if ($ele.length) {
                                                ...
                                                result =
                                                    eleVal &&
                                                    eleVal.length &&
                                                    eleVal !== 'State/province';
                                            }

                                            cb(result);
                                        },
                                        errorMessage:
                                            this.shippingErrorMessages.province,
                                    },
                                ]);
                            };
                        /**
                        ...
                        _proto.bindUPSRates = function bindUPSRates() {
                            ...
                            $('body').on(
                                ...
                                UPSRateToggle,
                                function (event) {
                                    var $estimatorFormUps = $(
                                        '.estimator-form--ups',
                                    );
                                    var $estimatorFormDefault = $(
                                        '.estimator-form--default',
                                    );
                                    event.preventDefault();
                                    $estimatorFormUps.toggleClass(
                                        'u-hiddenVisually',
                                    );
                                    $estimatorFormDefault.toggleClass(
                                        'u-hiddenVisually',
                                    );
                                },
                            );
                        ...
                        _proto.bindStateCountryChange =
                            function bindStateCountryChange() {
                                var _this3 = this;

                                var $last; // Requests the states for a country with AJAX

                                Object(
                                    _common_state_country__WEBPACK_IMPORTED_MODULE_0__[
                                        'default'
                                    ],
                                )(
                                    this.$state,
                                    ...
                                    function (err, field) {
                                        if (err) {
                                            Object(
                                                _global_modal__WEBPACK_IMPORTED_MODULE_5__[
                                                    'showAlertModal'
                                                ],
                                            )(err);
                                            throw new Error(err);
                                        ...
                                        if (
                                            _this3.shippingValidator.getStatus(
                                                _this3.$state,
                                            ) !== 'undefined'
                                        ) {
                                            _this3.shippingValidator.remove(
                                                _this3.$state,
                                            );
                                        }
                                        ...
                                        if ($field.is('select')) {
                                            ...
                                            _common_utils_form_utils__WEBPACK_IMPORTED_MODULE_3__[
                                                'Validators'
                        ...
                        _proto.toggleEstimatorFormState =
                            function toggleEstimatorFormState(
                                toggleButton,
                                buttonSelector,
                                $toggleContainer,
                            ) {
                                var changeAttributesOnToggle =
                                    function changeAttributesOnToggle(
                                        selectorToActivate,
                                    ) {
                                        $(toggleButton).attr(
                                            'aria-labelledby',
                                ...
                                this.isEstimatorFormOpened =
                                    !this.isEstimatorFormOpened;
                            };

                        _proto.bindEstimatorEvents =
                            function bindEstimatorEvents() {
                                var _this4 = this;

                                var $estimatorContainer = $(
                                    '.shipping-estimator',
                                );
                                var $estimatorForm = $('.estimator-form');
                                Object(
                                    _common_collapsible__WEBPACK_IMPORTED_MODULE_4__[
                                        'default'
                                    ],
                                )();
                                $estimatorForm.on('submit', function (event) {
                                    ...
                                    _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_2__[
                                        ...
                                        function (err, response) {
                                            ...
                                            $('.select-shipping-quote').on(
                                                'click',
                                                function (clickEvent) {
                                                    var quoteId = $(
                                                        '.shipping-quote:checked',
                                                    ).val();
                                                    clickEvent.preventDefault();
                                                    _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_2__[
                                                        'default'
                                                    ].api.cart.submitShippingQuote(
                                                        quoteId,
                                                        function () {
                                ...
                                $('.shipping-estimate-show').on(
                                    'click',
                                    function (event) {
                                        event.preventDefault();

                                        _this4.toggleEstimatorFormState(
                                            event.currentTarget,
  ...
  \*****************************************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* WEBPACK VAR INJECTION */ (function ($) {
                    ...
                    /* harmony import */ var _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_1__ =
                        __webpack_require__(
                            /*! @bigcommerce/stencil-utils */ './node_modules/@bigcommerce/stencil-utils/src/main.js',
                        );
                    /* harmony import */ var _product_details_base__WEBPACK_IMPORTED_MODULE_2__ =
                        __webpack_require__(
                            /*! ./product-details-base */ './assets/js/theme/common/product-details-base.js',
                        );
                    /* harmony import */ var _utils_ie_helpers__WEBPACK_IMPORTED_MODULE_3__ =
                        __webpack_require__(
                            /*! ./utils/ie-helpers */ './assets/js/theme/common/utils/ie-helpers.js',
                        );
                    ...
                    var CartItemDetails = /*#__PURE__*/ (function (
                        _ProductDetailsBase,
                    ) {
                        ...
                        function CartItemDetails(
                            ...
                            var $productOptionsElement = $(
                                '[data-product-attributes-wrapper]',
                                $form,
                            );
                            var hasOptions = $productOptionsElement
                                .html()
                                .trim().length;
                            var hasDefaultOptions =
                                $productOptionsElement.find(
                                    '[data-default]',
                                ).length;
                            $productOptionsElement.on('change', function () {
                                _this.setProductVariant();
                            });
                            var optionChangeCallback =
                                _product_details_base__WEBPACK_IMPORTED_MODULE_2__[
                            ...
                            if (
                                ...
                                var productId =
                                    _this.context.productForChangeId;
                                _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_1__[
                                    'default'
                                ].api.productAttributes.optionChange(
                                    productId,
                                    $form.serialize(),
                            ...
                            function setProductVariant() {
                                ...
                                $.each(
                                    ...
                                    function (index, value) {
                                        ...
                                        var optionTitle = optionLabel
                                            .split(':')[0]
                                            .trim();
                                        var required = optionLabel
                                            .toLowerCase()
                                            .includes('required');
                                        var type = value.getAttribute(
                                            'data-product-attribute',
                                        );
                                        ...
                                        if (
                                            ...
                                            unsatisfiedRequiredFields.push(
                                                value,
                                            );
                                        }
                                        ...
                                        if (
                                            ...
                                            if (checked) {
                                                var getSelectedOptionLabel =
                                                    function getSelectedOptionLabel() {
                                                        var productVariantslist =
                                                            Object(
                                                                _utils_ie_helpers__WEBPACK_IMPORTED_MODULE_3__[
                                                                    'convertIntoArray'
                                                                ],
                                                            )(value.children);

                                                        var matchLabelForCheckedInput =
                                                            function matchLabelForCheckedInput(
                                                                inpt,
                                                            ) {
                                                                return (
                                                                    inpt.dataset
                        ...
                        _proto.updateProductAttributes =
                            function updateProductAttributes(data) {
                                _ProductDetailsBase.prototype.updateProductAttributes.call(
                                    this,
                                    data,
                                );
  ...
  \*************************************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* WEBPACK VAR INJECTION */ (function ($) {
                    ...
                    /* harmony import */ var lodash_transform__WEBPACK_IMPORTED_MODULE_1__ =
                        __webpack_require__(
                            /*! lodash/transform */ './node_modules/lodash/transform.js',
                        );
                    /* harmony import */ var lodash_transform__WEBPACK_IMPORTED_MODULE_1___default =
                        /*#__PURE__*/ __webpack_require__.n(
                            lodash_transform__WEBPACK_IMPORTED_MODULE_1__,
                        );
                    /* harmony import */ var _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_2__ =
                        __webpack_require__(
                            /*! @bigcommerce/stencil-utils */ './node_modules/@bigcommerce/stencil-utils/src/main.js',
                        );
                    /* harmony import */ var _utils_form_utils__WEBPACK_IMPORTED_MODULE_3__ =
                        __webpack_require__(
                            /*! ./utils/form-utils */ './assets/js/theme/common/utils/form-utils.js',
                        );
                    /* harmony import */ var _global_modal__WEBPACK_IMPORTED_MODULE_4__ =
                        __webpack_require__(
                            /*! ../global/modal */ './assets/js/theme/global/modal.js',
                        );
                    ...
                    function makeStateRequired(stateElement, context) {
                        var attrs =
                            lodash_transform__WEBPACK_IMPORTED_MODULE_1___default()(
                                stateElement.prop('attributes'),
                        ...
                        stateElement.replaceWith(
                            $('<select></select>', replacementAttributes),
                        );
                    ...
                    function makeStateOptional(stateElement) {
                        ...
                        stateElement.replaceWith(
                            $('<input />', replacementAttributes),
                        );
                        var $newElement = $('[data-field-type="State"]');

                        if ($newElement.length !== 0) {
                            Object(
                                _utils_form_utils__WEBPACK_IMPORTED_MODULE_3__[
                    ...
                    /* harmony default export */ __webpack_exports__[
                        'default'
                    ] = function (stateElement, context, options, callback) {
                        if (context === void 0) {
                            context = {};
                        }
                        ...
                        $('select[data-field-type="Country"]').on(
                            'change',
                            function (event) {
                                ...
                                _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_2__[
                                    'default'
                                ].api.country.getByName(
                                    countryName,
                                    function (err, response) {
                                        if (err) {
                                            Object(
                                                _global_modal__WEBPACK_IMPORTED_MODULE_4__[
                                                    'showAlertModal'
                                                ],
                                            )(context.state_error);
                                            return callback(err);
                                        ...
                                        if (
                                            ...
                                            var newElement = makeStateOptional(
                                                $currentInput,
                                                context,
                                            );
  ...
  \************************************************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* harmony export (binding) */ __webpack_require__.d(
                    ...
                    'createTranslationDictionary',
                    function () {
                        return createTranslationDictionary;
                    },
                );
                var TRANSLATIONS = 'translations';

                var isTranslationDictionaryNotEmpty =
                    function isTranslationDictionaryNotEmpty(dictionary) {
                ...
                var createTranslationDictionary =
                    function createTranslationDictionary(context) {
                        var validationDictionaryJSON =
                                context.validationDictionaryJSON,
                            validationFallbackDictionaryJSON =
                                context.validationFallbackDictionaryJSON,
                            validationDefaultDictionaryJSON =
                                context.validationDefaultDictionaryJSON;
                        var activeDictionary = chooseActiveDictionary(
                            validationDictionaryJSON,
                            validationFallbackDictionaryJSON,
                            validationDefaultDictionaryJSON,
                        );
                        var localizations = Object.values(
                            activeDictionary[TRANSLATIONS],
                        );
                        var translationKeys = Object.keys(
                            activeDictionary[TRANSLATIONS],
                        ).map(function (key) {
