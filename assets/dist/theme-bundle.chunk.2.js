  ...
  \*********************************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* WEBPACK VAR INJECTION */ (function ($) {
                    ...
                    /* harmony import */ var _common_gift_certificate_validator__WEBPACK_IMPORTED_MODULE_2__ =
                        __webpack_require__(
                            /*! ./common/gift-certificate-validator */ './assets/js/theme/common/gift-certificate-validator.js',
                        );
                    /* harmony import */ var _common_models_forms__WEBPACK_IMPORTED_MODULE_3__ =
                        __webpack_require__(
                            /*! ./common/models/forms */ './assets/js/theme/common/models/forms.js',
                        );
                    ...
                    /* harmony import */ var _common_utils_form_utils__WEBPACK_IMPORTED_MODULE_5__ =
                        __webpack_require__(
                            /*! ./common/utils/form-utils */ './assets/js/theme/common/utils/form-utils.js',
                        );
                    /* harmony import */ var _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_6__ =
                        __webpack_require__(
                    ...
                    var GiftCertificate = /*#__PURE__*/ (function (
                        ...
                        function GiftCertificate(context) {
                            ...
                            var purchaseModel = {
                                ...
                                recipientEmail: function recipientEmail() {
                                    return _common_models_forms__WEBPACK_IMPORTED_MODULE_3__[
                                        'default'
                                    ].email.apply(
                                        _common_models_forms__WEBPACK_IMPORTED_MODULE_3__[
                                            'default'
                                        ],
                                        arguments,
                                    );
                                ...
                                customAmount: function customAmount(
                                    value,
                                    min,
                                    max,
                                ) {
                            ...
                            var $customAmounts = $purchaseForm.find(
                                'input[name="certificate_amount"]',
                            );
                            var purchaseValidator = Object(
                                ...
                                delay: 300,
                                tap: _common_utils_form_utils__WEBPACK_IMPORTED_MODULE_5__[
                                    'announceInputErrorMessage'
                                ],
                            });

                            if ($customAmounts.length) {
                                var $element = $purchaseForm.find(
                                    'input[name="certificate_amount"]',
                                );
                                var min = $element.data('min');
                                var minFormatted =
                                    $element.data('minFormatted');
                                var max = $element.data('max');
                                var maxFormatted =
                                    $element.data('maxFormatted');

                                var insertFormattedAmountsIntoErrorMessage =
                                    function insertFormattedAmountsIntoErrorMessage(
                                        message,
                                    ) {
                                        for (
                                            var _len = arguments.length,
                                                amountRange = new Array(
                                                    _len > 1 ? _len - 1 : 0,
                                                ),
                                                _key = 1;
                                            _key < _len;
                                        ...
                                        var amountPlaceholders = [
                                            '[MIN]',
                                            '[MAX]',
                                        ];
                                        var updatedErrorText = message;
                                        amountPlaceholders.forEach(
                                            function (placeholder, i) {
                                                updatedErrorText =
                                                    updatedErrorText.includes(
                                                        placeholder,
                                                    )
                                                        ? updatedErrorText.replace(
                                                              placeholder,
                                                              amountRange[i],
                                                          )
                                                        : updatedErrorText;
                                ...
                                purchaseValidator.add({
                                    selector:
                                        '#gift-certificate-form input[name="certificate_amount"]',
                                    ...
                                    errorMessage:
                                        insertFormattedAmountsIntoErrorMessage(
                                            _this.validationDictionary
                            ...
                            purchaseValidator.add([
                                {
                                    selector:
                                        '#gift-certificate-form input[name="to_name"]',
                                    validate: function validate(cb, val) {
                                        var result =
                                            purchaseModel.recipientName(val);
                                        cb(result);
                                    },
                                ...
                                {
                                    selector:
                                        '#gift-certificate-form input[name="to_email"]',
                                    validate: function validate(cb, val) {
                                        var result =
                                            purchaseModel.recipientEmail(val);
                                        cb(result);
                                    },
                                ...
                                {
                                    selector:
                                        '#gift-certificate-form input[name="from_name"]',
                                    validate: function validate(cb, val) {
                                        var result =
                                            purchaseModel.senderName(val);
                                        cb(result);
                                    },
                                ...
                                {
                                    selector:
                                        '#gift-certificate-form input[name="from_email"]',
                                    validate: function validate(cb, val) {
                                        var result =
                                            purchaseModel.senderEmail(val);
                                        cb(result);
                                    },
                                ...
                                },
                                {
                                    ...
                                    triggeredBy:
                                        '#gift-certificate-form input[name="certificate_theme"]',
                                    validate: function validate(cb) {
                                        var val = $purchaseForm
                                            .find(
                                ...
                                {
                                    selector:
                                        '#gift-certificate-form input[name="agree"]',
                                    validate: function validate(cb) {
                                        var val = $purchaseForm
                                ...
                                {
                                    selector:
                                        '#gift-certificate-form input[name="agree2"]',
                                    validate: function validate(cb) {
                                        var val = $purchaseForm
                                            .find('input[name="agree2"]')
                                            .get(0).checked;
                                        cb(val);
                                    },
                                    errorMessage: _this.context.agreeToTerms,
                            ...
                            if ($certBalanceForm.length) {
                                var balanceVal =
                                    _this.checkCertBalanceValidator(
                                        $certBalanceForm,
                                    );
                            ...
                            $('#gift-certificate-preview').click(
                                function (event) {
                                    ...
                                    _bigcommerce_stencil_utils__WEBPACK_IMPORTED_MODULE_6__[
                                        ...
                                        function (err, content) {
                                            if (err) {
                                                return modal.updateContent(
                                                    _this.context.previewError,
                                                );
                                            }
                        ...
                        _proto.checkCertBalanceValidator =
                            function checkCertBalanceValidator($balanceForm) {
                                var balanceValidator = Object(
                                    _common_nod__WEBPACK_IMPORTED_MODULE_1__[
                                        'default'
                                    ],
                                )({
                                    submit: $balanceForm.find(
                                        'input[type="submit"]',
                                    ),
                                    tap: _common_utils_form_utils__WEBPACK_IMPORTED_MODULE_5__[
                                        'announceInputErrorMessage'
                                ...
                                balanceValidator.add({
                                    selector: $balanceForm.find(
                                        'input[name="giftcertificatecode"]',
                                    ),
                                    validate: function validate(cb, val) {
                                        cb(
                                            Object(
                                                _common_gift_certificate_validator__WEBPACK_IMPORTED_MODULE_2__[
                                                    'default'
                                                ],
                                            )(val),
                                        );
