  ...
  \***************************************************/
            ...
            /***/ function (module, __webpack_exports__, __webpack_require__) {
                ...
                /* WEBPACK VAR INJECTION */ (function ($) {
                    /* harmony import */ var _utils_translations_utils__WEBPACK_IMPORTED_MODULE_0__ =
                        __webpack_require__(
                            /*! ./utils/translations-utils */ './assets/js/theme/common/utils/translations-utils.js',
                        );
                    ...
                    function buildRequiredCheckboxValidation(
                        validation,
                        $formField,
                        errorText,
                    ) {
                        ...
                        var primarySelector =
                            '#' + formFieldId + ' input:first-of-type';
                    ...
                    function buildNumberRangeValidation(
                        validation,
                        formFieldSelector,
                    ) {
                        var invalidMessage =
                    ...
                    function buildValidation(
                        ...
                        var validation =
                            $validateableElement.data('validation');
                        var fieldValidations = [];
                        var formFieldSelector =
                            '#' + $validateableElement.attr('id');

                        if (validation.type === 'datechooser') {
                            var dateValidation = buildDateValidation(
                                $validateableElement,
                                validation,
                                errorMessage,
                            );
                            ...
                            validation.required &&
                            (validation.type === 'checkboxselect' ||
                                validation.type === 'radioselect')
                        ) {
                    ...
                    /* harmony default export */ __webpack_exports__[
                        ...
                        var _createTranslationDic = Object(
                                _utils_translations_utils__WEBPACK_IMPORTED_MODULE_0__[
                                    'createTranslationDictionary'
                                ],
                            )(context),
                            requiredFieldValidationText =
                                _createTranslationDic.field_not_blank;
